...
import Description from './ModalDescription.svelte';
...
export type { ModalDescriptionProps } from './ModalDescription.svelte';

const Modal = Object.assign(Root, { Root, Header, Body, Footer, Close, Description });
export { Modal };
